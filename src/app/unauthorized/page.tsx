...
export default function UnauthorizedPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 font-sans text-xs text-slate-400">
      ...
      <div className="w-full max-w-md bg-surface border border-slate-800 rounded-2xl p-6 text-center space-y-6 shadow-2xl relative z-10 animate-fadeIn">
